package com.bank.islamic.musharakahpartnershipfinancing.model;
...
/**
 * The BIAN control record for this service domain: "Musharakah Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Musharakah Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Musharakah Facility Fulfillment Arrangement";
